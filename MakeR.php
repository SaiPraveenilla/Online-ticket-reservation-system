     ...
     <div class="templatemo-flex-row">
      ...
      ?>
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="#"><i class="fa fa-sliders fa-fw"></i>Make Reservation</a>
            </li>
            <li>
      ...
      <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10" align="center" style="color: red; font-size: 30px;">Booking</h2>
            
            <form action="booking.php" class="templatemo-login-form" method="post" enctype="multipart/form-data"> 
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="datetime-local" name="DOB" class="form-control" id="DOB" placeholder="DD/MM/YYYY" min="2020-07-30T00:00" max="2020-09-30T00:00">
                </div>
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">TimeZone</label>
        ...
        <button type="submit"  name="submit" class="templatemo-blue-button">BOOK</button>
